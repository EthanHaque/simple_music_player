package com.haque; /**
 * *****************************************************************************
 * Compilation:  javac com.haque.StdAudio.java
 * Execution:    java com.haque.StdAudio
 * Dependencies: none
 * <p>
...
public final class StdAudio {
    ...
    private static SourceDataLine line;   // to com.haque.play the sound
     ...
     *
     * @param  sample the sample to com.haque.play
     ...
     *
     * @param  samples the array of samples to com.haque.play
     * @throws IllegalArgumentException if any sample is {@code Double.NaN}
     * @throws IllegalArgumentException if {@code samples} is {@code null}
     */
    public static void play(double[] samples) {
        if (samples == null) throw new IllegalArgumentException("argument to com.haque.play() is null");
     ...
     *
     * @param filename the name of the audio file
     * @throws IllegalArgumentException if unable to com.haque.play {@code filename}
    ...
    public static synchronized void play(final String filename) {
        ...
        // something else went wrong
            ...
            throw new IllegalArgumentException("could not com.haque.play '" + filename + "'", ioe);
        }

    }


    // com.haque.play sound file using Applet.newAudioClip();
    private static void playApplet(String filename) {
        ...
        try {
            ...
            throw new IllegalArgumentException("could not com.haque.play '" + filename + "'", e);
        }

        // URL url = com.haque.StdAudio.class.getResource(filename);
        if (url == null) {
            throw new IllegalArgumentException("could not com.haque.play '" + filename + "'");
        }
    ...
    // com.haque.play a wav or aif file
    ...
    /***************************************************************************
     * Unit tests {@code com.haque.StdAudio}.
     ***************************************************************************/
    ...
    /**
     * Test client - com.haque.play an A major scale to standard audio.
     *
