package com.haque; /******************************************************************************
 *  Compilation:  javac com.haque.StdIn.java
 *  Execution:    java com.haque.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 * The {@code com.haque.StdIn} class provides static methods for reading strings
 ...
 * <pre>
 * while (com.haque.StdIn.hasNextChar()) {
 *     char c = com.haque.StdIn.readChar();
 *     com.haque.StdOut.print(c);
 * }
 * </pre>
 * p>
 ...
 * <pre>
 * while (com.haque.StdIn.hasNextLine()) {
 *     String line = com.haque.StdIn.readLine();
 *     com.haque.StdOut.println(line);
 * }
 * </pre>
 * p>
 ...
 * <pre>
 * String[] words = com.haque.StdIn.readAllStrings();
 * </pre>
 * p>
 * <b>Differences with Scanner.</b>
 * {@code com.haque.StdIn} and {@link Scanner} are both designed to parse
 * tokens and convert them to primitive types and strings.
 * Some of the main differences are summarized below:
 * <ul>
 * <li> {@code com.haque.StdIn} is a set of static methods and reads
 ...
 *      and sockets.
 * <li> {@code com.haque.StdIn} uses whitespace as the delimiter between tokens.
 * <li> {@code com.haque.StdIn} coerces the character-set encoding to UTF-8,
 *      which is a standard character encoding for Unicode.
 * <li> {@code com.haque.StdIn} coerces the locale to {@link Locale#US},
 *      for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *      and floating-point literals.
 * <li> {@code com.haque.StdIn} has convenient methods for reading a single
 *      character; reading in sequences of integers, doubles, or strings;
 *      and reading in all of the remaining input.
 * </ul>
 * p>
 * Historical note: {@code com.haque.StdIn} preceded {@code Scanner}; when
 ...
 * Windows, and Linux.
 * The methods in {@code com.haque.StdIn} are <em>blocking</em>, which means that they
 ...
 * If the input begins with the optional byte-order mask, {@code com.haque.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to com.haque.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to com.haque.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to com.haque.StdIn,
    ...
    //// end: section (2 of 2) of code duplicated from In to com.haque.StdIn


    // do this once when com.haque.StdIn is initialized
    static {
        resync();
    }

    /**
     * If com.haque.StdIn changes, use this to reinitialize the scanner.
     */
